...
//  [altBeaconParser setBeaconLayout:@"m:2-3=beac,i:4-19,i:20-21,i:22-23,p:24-24,d:25-25" error: Nil ];
  [altBeaconParser setBeaconLayout:@"m:2-3=0215,i:4-15,i:16-19,i:20-23,p:24-24" error: Nil ];
  ...
  RNLBeaconParser *tlmBeaconParser = [RNLBeaconParser new];
  [tlmBeaconParser setBeaconLayout:@"x,s:0-1=feaa,m:2-2=20,d:3-3,d:4-5,d:6-7,d:8-11,d:12-15" error:nil];
  RNLBeaconParser *urlBeaconParser = [RNLBeaconParser new];
  [urlBeaconParser setBeaconLayout:@"s:0-1=feaa,m:2-2=10,p:3-3:-41,i:4-20" error:nil];
  self.beaconParsers = @[ altBeaconParser, uidBeaconParser, tlmBeaconParser, urlBeaconParser ];
...
- (void)centralManagerDidUpdateState:(CBCentralManager *)central {
  if (central.state == CBManagerStatePoweredOn && self.scanning) {
